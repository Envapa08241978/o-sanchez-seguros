              ...
              <ScrollReveal delay={100}>
                <div className="bg-surface rounded-2xl border border-border p-7 shadow-sm">
                  ...
                  <ul className="space-y-5">
                    ...
                    <li>
                      <a href={SITE_CONFIG.googleMapsUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 group">
                        <span className="flex items-center justify-center w-12 h-12 bg-brand/5 text-brand rounded-xl group-hover:bg-brand group-hover:text-white transition-all">
                          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-semibold text-accent group-hover:text-brand transition-colors">Ver en Google Maps</p>
                        </div>
                      </a>
                    </li>
                  </ul>
