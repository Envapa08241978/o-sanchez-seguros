...
export default function QuotesList({ isOpen, onRefresh }: Props) {
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody>
            {loading ? (
              ...
              <tr><td colSpan={6} className="p-12 text-center"><p className="text-sm font-bold text-brand">Sin cotizaciones aún</p><p className="text-xs text-muted mt-1">Genera tu primera presentación con el botón de arriba</p></td></tr>
            ) : quotes.map(q => {
